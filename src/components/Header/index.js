...
const Header = () => {
  ...
  return (
    <header>
      <nav className=" border-gray-200 px-4 lg:px-6 py-2.5 shadow-primary shadow-sm">
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
          <Link to="/" className="flex items-center">
            <span className="self-center text-xl font-semibold whitespace-nowrap text-primary">
              {/* <img
                src={null ?? ""}
                alt="meta digital one"
                height="40px"
                width="40px"
              /> */}
              <h1 className="text-2xl">Employee Time Management System</h1>
            </span>
          </Link>
